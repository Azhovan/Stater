...
class StateMachineTest extends TestCase
{
	...
	public function test_factory_state_machine_class_with_different_conditions ()
	{
		$inputs = $this->factory_class_provider();

		$machine = (new MachineFactory())->create($inputs);

		$t1 = $machine->can("state1", "state2",[
			'condition' => [
				'param1' => true
			]
		]);

		$t2 = $machine->can("state0", "state00");
		$t3 = $machine->can("state1", "state4");
		$t4 = $machine->can("state1", "state5");
		$t5 = $machine->can("state3", "state4");
	...
	private function factory_class_provider ()
	{
		return [
			// 1
			 'regular-call' => [
				...
				"transitionTo" => ["name" => "state00", "data" => ""],
				"callback" => function () {
					return true;
				}
			],
			...
			// 2
		 	'the-starting-state-is-duplicate-and-is-string' => [
				"state" => "state1",
				"event" => ["name" => "event1", "data" => "589"],
				"condition" => function ($inputs) {
					return $inputs;
				},
				"transitionTo" => ["name" => "state2", "data" => "123"],
			...
			// 3
			 'the-event-is-duplicate-and-is-string-plus-state1-is-repitetive' => [
				"state" => 'state1',
				"event" => 'event1',
				"condition" => function () {
					return true;
				},
				"transitionTo" => ["name" => "state4", "data" => ""],
				"callback" => function () {
					return true;
				}
			],
			...
			// 4
			'the-end-state-is-duplicate-and-is-string' => [
				"state" => 'state1',
				"event" => 'event1',
				"condition" => function () {
					return true;
